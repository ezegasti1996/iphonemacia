  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-[#05070A]/80 backdrop-blur-md border-b border-white/5">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        {/* Rebranded Logo - Static HD */}
        <div className="flex items-center gap-3 cursor-pointer group select-none">
          {/* Icon Container */}
          <div className="w-10 h-10 bg-gradient-to-br from-[#FF9900] to-[#E88B00] rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/20">
            <img
          ...
          <div className="flex flex-col justify-center relative">
            <div className="flex items-baseline gap-[2px] relative group">
              <span className="text-xl font-black italic tracking-tighter text-white font-heading leading-none drop-shadow-md relative px-0.5">
                FBA
              </span>
              <span className="text-xl font-black italic tracking-tighter text-[#FF9900] font-heading leading-none drop-shadow-md relative pl-0.5 pr-6">
                ACADEMY
              </span>
            </div>
